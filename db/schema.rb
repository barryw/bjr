...
ActiveRecord::Schema.define(version: 20_200_607_180_327) do
  create_table 'folders', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci', force: :cascade do |t|
    t.string 'name', limit: 50, null: false
    t.string 'expression', limit: 100, null: false
    t.bigint 'user_id', null: false
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[name user_id], name: 'index_folders_on_name_and_user_id', unique: true
  ...
  create_table 'job_runs', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC', force: :cascade do |t|
    ...
    t.text 'stdout', limit: 4_294_967_295
    t.text 'stderr', limit: 4_294_967_295
    ...
    t.index %w[job_id created_at], name: 'index_job_runs_on_job_id_and_created_at'
    t.index %w[job_id start_time is_manual], name: 'index_job_runs_on_job_id_and_start_time_and_is_manual'
  ...
  create_table 'jobs', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC', force: :cascade do |t|
    ...
    t.index %w[name user_id], name: 'index_jobs_on_name_and_user_id', unique: true
