...
abstract class TodaysStatsMessage implements Built<TodaysStatsMessage, TodaysStatsMessageBuilder> {
    ...
    static void _initializeBuilder(TodaysStatsMessageBuilder b) => b;

    factory TodaysStatsMessage([void updates(TodaysStatsMessageBuilder b)]) = _$TodaysStatsMessage;

    @BuiltValueSerializer(custom: true)
    static Serializer<TodaysStatsMessage> get serializer => _$TodaysStatsMessageSerializer();
}

class _$TodaysStatsMessageSerializer implements StructuredSerializer<TodaysStatsMessage> {

    @override
    final Iterable<Type> types = const [TodaysStatsMessage, _$TodaysStatsMessage];
    @override
    final String wireName = r'TodaysStatsMessage';

    @override
    Iterable<Object> serialize(Serializers serializers, TodaysStatsMessage object,
        ...
        if (object.object != null) {
            result
                ...
                ..add(serializers.serialize(object.object,
                    specifiedType: const FullType(TodaysStats)));
        }
        return result;
    }

    @override
    TodaysStatsMessage deserialize(Serializers serializers, Iterable<Object> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = TodaysStatsMessageBuilder();
            ...
            switch (key) {
                ...
                case r'object':
                    result.object.replace(serializers.deserialize(value,
                        specifiedType: const FullType(TodaysStats)) as TodaysStats);
                    break;
            }
        }
        return result.build();
