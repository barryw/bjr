...
abstract class TimezoneMessage implements Built<TimezoneMessage, TimezoneMessageBuilder> {
    ...
    static void _initializeBuilder(TimezoneMessageBuilder b) => b;

    factory TimezoneMessage([void updates(TimezoneMessageBuilder b)]) = _$TimezoneMessage;

    @BuiltValueSerializer(custom: true)
    static Serializer<TimezoneMessage> get serializer => _$TimezoneMessageSerializer();
}

class _$TimezoneMessageSerializer implements StructuredSerializer<TimezoneMessage> {

    @override
    final Iterable<Type> types = const [TimezoneMessage, _$TimezoneMessage];
    @override
    final String wireName = r'TimezoneMessage';

    @override
    Iterable<Object> serialize(Serializers serializers, TimezoneMessage object,
    ...
    @override
    TimezoneMessage deserialize(Serializers serializers, Iterable<Object> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = TimezoneMessageBuilder();
