...
abstract class SingleJobRunMessage implements Built<SingleJobRunMessage, SingleJobRunMessageBuilder> {
    ...
    static void _initializeBuilder(SingleJobRunMessageBuilder b) => b;

    factory SingleJobRunMessage([void updates(SingleJobRunMessageBuilder b)]) = _$SingleJobRunMessage;

    @BuiltValueSerializer(custom: true)
    static Serializer<SingleJobRunMessage> get serializer => _$SingleJobRunMessageSerializer();
}

class _$SingleJobRunMessageSerializer implements StructuredSerializer<SingleJobRunMessage> {

    @override
    final Iterable<Type> types = const [SingleJobRunMessage, _$SingleJobRunMessage];
    @override
    final String wireName = r'SingleJobRunMessage';

    @override
    Iterable<Object> serialize(Serializers serializers, SingleJobRunMessage object,
        ...
        if (object.object != null) {
            result
                ...
                ..add(serializers.serialize(object.object,
                    specifiedType: const FullType(SingleJobRun)));
        }
        return result;
    }

    @override
    SingleJobRunMessage deserialize(Serializers serializers, Iterable<Object> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = SingleJobRunMessageBuilder();
            ...
            switch (key) {
                ...
                case r'object':
                    result.object.replace(serializers.deserialize(value,
                        specifiedType: const FullType(SingleJobRun)) as SingleJobRun);
                    break;
            }
        }
        return result.build();
