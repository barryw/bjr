...
abstract class SingleFolderMessage implements Built<SingleFolderMessage, SingleFolderMessageBuilder> {
    ...
    static void _initializeBuilder(SingleFolderMessageBuilder b) => b;

    factory SingleFolderMessage([void updates(SingleFolderMessageBuilder b)]) = _$SingleFolderMessage;

    @BuiltValueSerializer(custom: true)
    static Serializer<SingleFolderMessage> get serializer => _$SingleFolderMessageSerializer();
}

class _$SingleFolderMessageSerializer implements StructuredSerializer<SingleFolderMessage> {

    @override
    final Iterable<Type> types = const [SingleFolderMessage, _$SingleFolderMessage];
    @override
    final String wireName = r'SingleFolderMessage';

    @override
    Iterable<Object> serialize(Serializers serializers, SingleFolderMessage object,
        ...
        if (object.object != null) {
            result
                ...
                ..add(serializers.serialize(object.object,
                    specifiedType: const FullType(SingleFolder)));
        }
        return result;
    }

    @override
    SingleFolderMessage deserialize(Serializers serializers, Iterable<Object> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = SingleFolderMessageBuilder();
            ...
            switch (key) {
                ...
                case r'object':
                    result.object.replace(serializers.deserialize(value,
                        specifiedType: const FullType(SingleFolder)) as SingleFolder);
                    break;
            }
        }
        return result.build();
