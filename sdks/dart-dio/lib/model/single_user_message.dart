...
abstract class SingleUserMessage implements Built<SingleUserMessage, SingleUserMessageBuilder> {
    ...
    static void _initializeBuilder(SingleUserMessageBuilder b) => b;

    factory SingleUserMessage([void updates(SingleUserMessageBuilder b)]) = _$SingleUserMessage;

    @BuiltValueSerializer(custom: true)
    static Serializer<SingleUserMessage> get serializer => _$SingleUserMessageSerializer();
}

class _$SingleUserMessageSerializer implements StructuredSerializer<SingleUserMessage> {

    @override
    final Iterable<Type> types = const [SingleUserMessage, _$SingleUserMessage];
    @override
    final String wireName = r'SingleUserMessage';

    @override
    Iterable<Object> serialize(Serializers serializers, SingleUserMessage object,
        ...
        if (object.object != null) {
            result
                ...
                ..add(serializers.serialize(object.object,
                    specifiedType: const FullType(SingleUser)));
        }
        return result;
    }

    @override
    SingleUserMessage deserialize(Serializers serializers, Iterable<Object> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = SingleUserMessageBuilder();
            ...
            switch (key) {
                ...
                case r'object':
                    result.object.replace(serializers.deserialize(value,
                        specifiedType: const FullType(SingleUser)) as SingleUser);
                    break;
            }
        }
        return result.build();
