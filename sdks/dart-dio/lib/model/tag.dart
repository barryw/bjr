...
class _$TagSerializer implements StructuredSerializer<Tag> {
    ...
    Iterable<Object> serialize(Serializers serializers, Tag object,
        ...
        if (object.taggingsCount != null) {
            result
                ..add(r'taggings_count')
                ..add(serializers.serialize(object.taggingsCount,
                    specifiedType: const FullType(int)));
        }
        return result;
    }
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                ...
                case r'name':
                    ...
                    break;
                case r'taggings_count':
                    result.taggingsCount = serializers.deserialize(value,
                        specifiedType: const FullType(int)) as int;
                    break;
            }
        }
