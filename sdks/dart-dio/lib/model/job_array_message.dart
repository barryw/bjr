...
abstract class JobArrayMessage implements Built<JobArrayMessage, JobArrayMessageBuilder> {
    ...
    static void _initializeBuilder(JobArrayMessageBuilder b) => b;

    factory JobArrayMessage([void updates(JobArrayMessageBuilder b)]) = _$JobArrayMessage;

    @BuiltValueSerializer(custom: true)
    static Serializer<JobArrayMessage> get serializer => _$JobArrayMessageSerializer();
}

class _$JobArrayMessageSerializer implements StructuredSerializer<JobArrayMessage> {

    @override
    final Iterable<Type> types = const [JobArrayMessage, _$JobArrayMessage];
    @override
    final String wireName = r'JobArrayMessage';

    @override
    Iterable<Object> serialize(Serializers serializers, JobArrayMessage object,
        ...
        if (object.object != null) {
            result
                ...
                ..add(serializers.serialize(object.object,
                    specifiedType: const FullType(BuiltList, [FullType(SingleJob)])));
        }
        return result;
    }

    @override
    JobArrayMessage deserialize(Serializers serializers, Iterable<Object> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = JobArrayMessageBuilder();
            ...
            switch (key) {
                ...
                case r'object':
                    result.object.replace(serializers.deserialize(value,
                        specifiedType: const FullType(BuiltList, [FullType(SingleJob)])) as BuiltList<SingleJob>);
                    break;
            }
        }
        return result.build();
