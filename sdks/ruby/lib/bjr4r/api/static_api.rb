...
module BJR
  class StaticApi
    ...
    def get_tags_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'TagMessage'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['bearerAuth']

      new_options = opts.merge(
        :operation => :"StaticApi.get_tags",
    ...
    def get_timezones_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'TimezoneMessage'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['bearerAuth']

      new_options = opts.merge(
        :operation => :"StaticApi.get_timezones",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_version_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"StaticApi.get_version",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
