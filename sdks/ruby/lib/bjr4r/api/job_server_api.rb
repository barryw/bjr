...
module BJR
  class JobServerApi
    ...
    def get_busy_thread_count_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'BusyThreadCountMessage'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['bearerAuth']

      new_options = opts.merge(
        :operation => :"JobServerApi.get_busy_thread_count",
    ...
    def quiesce_node_with_http_info(host, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GenericMessage'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['bearerAuth']

      new_options = opts.merge(
        :operation => :"JobServerApi.quiesce_node",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def recent_jobs_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"JobServerApi.recent_jobs",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def stats_by_day_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'JobStatMessage'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['bearerAuth']

      new_options = opts.merge(
        :operation => :"JobServerApi.stats_by_day",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def stats_by_hour_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"JobServerApi.stats_by_hour",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def stats_by_minute_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"JobServerApi.stats_by_minute",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def stats_by_week_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"JobServerApi.stats_by_week",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def todays_stats_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'TodaysStatsMessage'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['bearerAuth']

      new_options = opts.merge(
        :operation => :"JobServerApi.todays_stats",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def upcoming_jobs_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"JobServerApi.upcoming_jobs",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
