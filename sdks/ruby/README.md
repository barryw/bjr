...
```shell
gem install ./bjr4r-1.8.0.gem
```

(for development, run `gem install --dev ./bjr4r-1.8.0.gem` to install the development dependencies)
...
## Documentation for Models
 ...
 - [BJR::TimezoneMessageObject](docs/TimezoneMessageObject.md)
