...
func (o FolderArrayMessage) MarshalJSON() ([]byte, error) {
...
type NullableFolderArrayMessage struct {
	value *FolderArrayMessage
	isSet bool
}

func (v NullableFolderArrayMessage) Get() *FolderArrayMessage {
	return v.value
}

func (v *NullableFolderArrayMessage) Set(val *FolderArrayMessage) {
	v.value = val
	v.isSet = true
}

func (v NullableFolderArrayMessage) IsSet() bool {
	return v.isSet
}

func (v *NullableFolderArrayMessage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFolderArrayMessage(val *FolderArrayMessage) *NullableFolderArrayMessage {
	return &NullableFolderArrayMessage{value: val, isSet: true}
}

func (v NullableFolderArrayMessage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFolderArrayMessage) UnmarshalJSON(src []byte) error {
	v.isSet = true
