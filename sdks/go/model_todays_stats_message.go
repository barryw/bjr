...
// TodaysStatsMessage struct for TodaysStatsMessage
type TodaysStatsMessage struct {
	...
	Object *TodaysStats `json:"object,omitempty"`
}
...
// SetObject gets a reference to the given TodaysStats and assigns it to the Object field.
func (o *TodaysStatsMessage) SetObject(v TodaysStats) {
	o.Object = &v
}

func (o TodaysStatsMessage) MarshalJSON() ([]byte, error) {
...
type NullableTodaysStatsMessage struct {
	value *TodaysStatsMessage
	isSet bool
}

func (v NullableTodaysStatsMessage) Get() *TodaysStatsMessage {
	return v.value
}

func (v *NullableTodaysStatsMessage) Set(val *TodaysStatsMessage) {
	v.value = val
	v.isSet = true
}

func (v NullableTodaysStatsMessage) IsSet() bool {
	return v.isSet
}

func (v *NullableTodaysStatsMessage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTodaysStatsMessage(val *TodaysStatsMessage) *NullableTodaysStatsMessage {
	return &NullableTodaysStatsMessage{value: val, isSet: true}
}

func (v NullableTodaysStatsMessage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTodaysStatsMessage) UnmarshalJSON(src []byte) error {
	v.isSet = true
