...
// JobRunArrayMessage struct for JobRunArrayMessage
type JobRunArrayMessage struct {
...
func (o JobRunArrayMessage) MarshalJSON() ([]byte, error) {
...
type NullableJobRunArrayMessage struct {
	value *JobRunArrayMessage
	isSet bool
}

func (v NullableJobRunArrayMessage) Get() *JobRunArrayMessage {
	return v.value
}

func (v *NullableJobRunArrayMessage) Set(val *JobRunArrayMessage) {
	v.value = val
	v.isSet = true
}

func (v NullableJobRunArrayMessage) IsSet() bool {
	return v.isSet
}

func (v *NullableJobRunArrayMessage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJobRunArrayMessage(val *JobRunArrayMessage) *NullableJobRunArrayMessage {
	return &NullableJobRunArrayMessage{value: val, isSet: true}
}

func (v NullableJobRunArrayMessage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJobRunArrayMessage) UnmarshalJSON(src []byte) error {
	v.isSet = true
