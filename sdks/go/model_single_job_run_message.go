...
// SingleJobRunMessage struct for SingleJobRunMessage
type SingleJobRunMessage struct {
	...
	Object *SingleJobRun `json:"object,omitempty"`
}
...
// SetObject gets a reference to the given SingleJobRun and assigns it to the Object field.
func (o *SingleJobRunMessage) SetObject(v SingleJobRun) {
	o.Object = &v
}

func (o SingleJobRunMessage) MarshalJSON() ([]byte, error) {
...
type NullableSingleJobRunMessage struct {
	value *SingleJobRunMessage
	isSet bool
}

func (v NullableSingleJobRunMessage) Get() *SingleJobRunMessage {
	return v.value
}

func (v *NullableSingleJobRunMessage) Set(val *SingleJobRunMessage) {
	v.value = val
	v.isSet = true
}

func (v NullableSingleJobRunMessage) IsSet() bool {
	return v.isSet
}

func (v *NullableSingleJobRunMessage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSingleJobRunMessage(val *SingleJobRunMessage) *NullableSingleJobRunMessage {
	return &NullableSingleJobRunMessage{value: val, isSet: true}
}

func (v NullableSingleJobRunMessage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSingleJobRunMessage) UnmarshalJSON(src []byte) error {
	v.isSet = true
