...
// SingleUserMessage struct for SingleUserMessage
type SingleUserMessage struct {
...
func (o SingleUserMessage) MarshalJSON() ([]byte, error) {
...
type NullableSingleUserMessage struct {
	value *SingleUserMessage
	isSet bool
}

func (v NullableSingleUserMessage) Get() *SingleUserMessage {
	return v.value
}

func (v *NullableSingleUserMessage) Set(val *SingleUserMessage) {
	v.value = val
	v.isSet = true
}

func (v NullableSingleUserMessage) IsSet() bool {
	return v.isSet
}

func (v *NullableSingleUserMessage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSingleUserMessage(val *SingleUserMessage) *NullableSingleUserMessage {
	return &NullableSingleUserMessage{value: val, isSet: true}
}

func (v NullableSingleUserMessage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSingleUserMessage) UnmarshalJSON(src []byte) error {
	v.isSet = true
