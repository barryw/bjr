...
class SingleUser(object):
    ...
    def __init__(self, id=None, username=None, created_at=None, updated_at=None):  # noqa: E501
        """SingleUser - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._username = None
