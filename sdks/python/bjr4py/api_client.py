...
from bjr4py import rest
from bjr4py.configuration import Configuration
from bjr4py.exceptions import ApiTypeError, ApiValueError, ApiException
from bjr4py.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.authenticate_user  # this is an instance of the class Endpoint
        api_instance.authenticate_user()  # this invokes api_instance.authenticate_user.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.authenticate_user.callable or self.callable in this class
