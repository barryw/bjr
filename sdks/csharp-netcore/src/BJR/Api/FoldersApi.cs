...
namespace BJR.Api
{
    ...
    public partial class FoldersApi : IFoldersApi
    {
        ...
        {
             BJR.Client.ApiResponse<SingleFolderMessage> localVarResponse = await CreateFolderAsyncWithHttpInfo(name, expression);
             return localVarResponse.Data;
        ...
        /// <param name="expression"></param>
        /// <returns>Task of ApiResponse (SingleFolderMessage)</returns>
        public async System.Threading.Tasks.Task<BJR.Client.ApiResponse<SingleFolderMessage>> CreateFolderAsyncWithHttpInfo (string name, string expression)
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new BJR.Client.ApiException(400, "Missing required parameter 'name' when calling FoldersApi->CreateFolder");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<SingleFolderMessage>("/folder_api", localVarRequestOptions, this.Configuration);
        ...
        {
             BJR.Client.ApiResponse<SingleFolderMessage> localVarResponse = await DeleteFolderAsyncWithHttpInfo(id);
             return localVarResponse.Data;
        ...
        /// <param name="id"></param>
        /// <returns>Task of ApiResponse (SingleFolderMessage)</returns>
        public async System.Threading.Tasks.Task<BJR.Client.ApiResponse<SingleFolderMessage>> DeleteFolderAsyncWithHttpInfo (int id)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<SingleFolderMessage>("/folder_api/{id}", localVarRequestOptions, this.Configuration);
        ...
        {
             BJR.Client.ApiResponse<SingleFolderMessage> localVarResponse = await GetFolderAsyncWithHttpInfo(id);
             return localVarResponse.Data;
        ...
        /// <param name="id"></param>
        /// <returns>Task of ApiResponse (SingleFolderMessage)</returns>
        public async System.Threading.Tasks.Task<BJR.Client.ApiResponse<SingleFolderMessage>> GetFolderAsyncWithHttpInfo (int id)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<SingleFolderMessage>("/folder_api/{id}", localVarRequestOptions, this.Configuration);
        ...
        {
             BJR.Client.ApiResponse<JobArrayMessage> localVarResponse = await GetFolderJobsAsyncWithHttpInfo(id, perPage, page);
             return localVarResponse.Data;
        ...
        /// <param name="page"> (optional)</param>
        /// <returns>Task of ApiResponse (JobArrayMessage)</returns>
        public async System.Threading.Tasks.Task<BJR.Client.ApiResponse<JobArrayMessage>> GetFolderJobsAsyncWithHttpInfo (int id, int? perPage = default(int?), int? page = default(int?))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<JobArrayMessage>("/folder_api/{id}/jobs", localVarRequestOptions, this.Configuration);
        ...
        {
             BJR.Client.ApiResponse<FolderArrayMessage> localVarResponse = await GetFoldersAsyncWithHttpInfo(perPage, page);
             return localVarResponse.Data;
        ...
        /// <param name="page"> (optional)</param>
        /// <returns>Task of ApiResponse (FolderArrayMessage)</returns>
        public async System.Threading.Tasks.Task<BJR.Client.ApiResponse<FolderArrayMessage>> GetFoldersAsyncWithHttpInfo (int? perPage = default(int?), int? page = default(int?))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<FolderArrayMessage>("/folder_api", localVarRequestOptions, this.Configuration);
        ...
        {
             BJR.Client.ApiResponse<SingleFolderMessage> localVarResponse = await UpdateFolderAsyncWithHttpInfo(id, name, expression);
             return localVarResponse.Data;
        ...
        /// <param name="expression"> (optional)</param>
        /// <returns>Task of ApiResponse (SingleFolderMessage)</returns>
        public async System.Threading.Tasks.Task<BJR.Client.ApiResponse<SingleFolderMessage>> UpdateFolderAsyncWithHttpInfo (int id, string name = default(string), string expression = default(string))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PutAsync<SingleFolderMessage>("/folder_api/{id}", localVarRequestOptions, this.Configuration);
