...
namespace BJR.Api
{
    ...
    public partial class StaticApi : IStaticApi
    {
        ...
        {
             BJR.Client.ApiResponse<TagMessage> localVarResponse = await GetTagsAsyncWithHttpInfo(perPage, page);
             return localVarResponse.Data;
        ...
        /// <param name="page"> (optional)</param>
        /// <returns>Task of ApiResponse (TagMessage)</returns>
        public async System.Threading.Tasks.Task<BJR.Client.ApiResponse<TagMessage>> GetTagsAsyncWithHttpInfo (int? perPage = default(int?), int? page = default(int?))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<TagMessage>("/tags", localVarRequestOptions, this.Configuration);
        ...
        {
             BJR.Client.ApiResponse<TimezoneMessage> localVarResponse = await GetTimezonesAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="BJR.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (TimezoneMessage)</returns>
        public async System.Threading.Tasks.Task<BJR.Client.ApiResponse<TimezoneMessage>> GetTimezonesAsyncWithHttpInfo ()
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<TimezoneMessage>("/timezones", localVarRequestOptions, this.Configuration);
        ...
        {
             BJR.Client.ApiResponse<ServerVersion> localVarResponse = await GetVersionAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="BJR.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (ServerVersion)</returns>
        public async System.Threading.Tasks.Task<BJR.Client.ApiResponse<ServerVersion>> GetVersionAsyncWithHttpInfo ()
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<ServerVersion>("/version", localVarRequestOptions, this.Configuration);
