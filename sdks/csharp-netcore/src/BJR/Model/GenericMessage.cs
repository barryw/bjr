...
namespace BJR.Model
{
    ...
    /// GenericMessage
    /// </summary>
    [DataContract(Name = "GenericMessage")]
    public partial class GenericMessage : IEquatable<GenericMessage>, IValidatableObject
    {
        /// <summary>
        ...
        public GenericMessage(string message = default(string), bool isError = default(bool), string objectType = default(string), int statusCode = default(int), Object _object = default(Object))
        {
        ...
        {
            return this.Equals(input as GenericMessage);
        }

        /// <summary>
        /// Returns true if GenericMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of GenericMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenericMessage input)
        {
            if (input == null)
                return false;
