...
namespace BJR.Model
{
    ...
    /// UserArrayMessage
    /// </summary>
    [DataContract(Name = "UserArrayMessage")]
    public partial class UserArrayMessage : IEquatable<UserArrayMessage>, IValidatableObject
    {
        ...
        public UserArrayMessage(string message = default(string), bool isError = default(bool), string objectType = default(string), int statusCode = default(int), List<SingleUser> _object = default(List<SingleUser>))
        {
        ...
        public List<SingleUser> Object { get; set; }
