...
namespace BJR.Model
{
    ...
    public partial class UserNewIn : IEquatable<UserNewIn>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="UserNewIn" /> class.
        /// </summary>
        /// <param name="username">The new user&#39;s username. Must be unique. (required).</param>
        ...
        public UserNewIn(string username = default(string), string password = default(string), string passwordConfirmation = default(string))
        {
            ...
            this.Username = username ?? throw new ArgumentNullException("username is a required property for UserNewIn and cannot be null");
            // to ensure "password" is required (not null)
            this.Password = password ?? throw new ArgumentNullException("password is a required property for UserNewIn and cannot be null");
            // to ensure "passwordConfirmation" is required (not null)
            this.PasswordConfirmation = passwordConfirmation ?? throw new ArgumentNullException("passwordConfirmation is a required property for UserNewIn and cannot be null");
        }
        ...
        [DataMember(Name = "password_confirmation", IsRequired = true, EmitDefaultValue = false)]
