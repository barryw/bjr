...
namespace BJR.Model
{
    ...
    public partial class TagMessage : IEquatable<TagMessage>, IValidatableObject
    {
        ...
        public TagMessage(string message = default(string), bool isError = default(bool), string objectType = default(string), int statusCode = default(int), List<Tag> _object = default(List<Tag>))
        {
        ...
        public List<Tag> Object { get; set; }
