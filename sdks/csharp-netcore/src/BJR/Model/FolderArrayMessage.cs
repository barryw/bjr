...
namespace BJR.Model
{
    ...
    /// FolderArrayMessage
    /// </summary>
    [DataContract(Name = "FolderArrayMessage")]
    public partial class FolderArrayMessage : IEquatable<FolderArrayMessage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FolderArrayMessage" /> class.
        /// </summary>
        ...
        public FolderArrayMessage(string message = default(string), bool isError = default(bool), string objectType = default(string), int statusCode = default(int), List<SingleFolder> _object = default(List<SingleFolder>))
        {
        ...
        public List<SingleFolder> Object { get; set; }
        ...
        {
            return this.Equals(input as FolderArrayMessage);
        }

        /// <summary>
        /// Returns true if FolderArrayMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of FolderArrayMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FolderArrayMessage input)
        {
            if (input == null)
                return false;
