...
namespace BJR.Model
{
    ...
    /// JobStatMessage
    /// </summary>
    [DataContract(Name = "JobStatMessage")]
    public partial class JobStatMessage : IEquatable<JobStatMessage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JobStatMessage" /> class.
        /// </summary>
        ...
        public JobStatMessage(string message = default(string), bool isError = default(bool), string objectType = default(string), int statusCode = default(int), List<JobStat> _object = default(List<JobStat>))
        {
        ...
        public List<JobStat> Object { get; set; }
        ...
        {
            return this.Equals(input as JobStatMessage);
        }

        /// <summary>
        /// Returns true if JobStatMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of JobStatMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobStatMessage input)
        {
            if (input == null)
                return false;
