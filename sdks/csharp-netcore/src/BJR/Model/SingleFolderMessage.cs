...
namespace BJR.Model
{
    ...
    /// SingleFolderMessage
    /// </summary>
    [DataContract(Name = "SingleFolderMessage")]
    public partial class SingleFolderMessage : IEquatable<SingleFolderMessage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SingleFolderMessage" /> class.
        /// </summary>
        ...
        public SingleFolderMessage(string message = default(string), bool isError = default(bool), string objectType = default(string), int statusCode = default(int), SingleFolder _object = default(SingleFolder))
        {
        ...
        public SingleFolder Object { get; set; }
        ...
        {
            return this.Equals(input as SingleFolderMessage);
        }

        /// <summary>
        /// Returns true if SingleFolderMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of SingleFolderMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SingleFolderMessage input)
        {
            if (input == null)
                return false;
