...
namespace BJR.Model
{
    ...
    /// JobRunArrayMessage
    /// </summary>
    [DataContract(Name = "JobRunArrayMessage")]
    public partial class JobRunArrayMessage : IEquatable<JobRunArrayMessage>, IValidatableObject
    {
        ...
        public JobRunArrayMessage(string message = default(string), bool isError = default(bool), string objectType = default(string), int statusCode = default(int), List<SingleJobRun> _object = default(List<SingleJobRun>))
        {
        ...
        public List<SingleJobRun> Object { get; set; }
