...
namespace BJR.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BusyThreadCountMessage")]
    public partial class BusyThreadCountMessage : IEquatable<BusyThreadCountMessage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BusyThreadCountMessage" /> class.
        /// </summary>
        ...
        public BusyThreadCountMessage(string message = default(string), bool isError = default(bool), string objectType = default(string), int statusCode = default(int), BusyThreadCountMessageObject _object = default(BusyThreadCountMessageObject))
        {
        ...
        public BusyThreadCountMessageObject Object { get; set; }
        ...
        {
            return this.Equals(input as BusyThreadCountMessage);
        }

        /// <summary>
        /// Returns true if BusyThreadCountMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of BusyThreadCountMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BusyThreadCountMessage input)
        {
            if (input == null)
                return false;
