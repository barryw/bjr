...
namespace BJR.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ServerVersion :  IEquatable<ServerVersion>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="_object">The BJR server version.</param>
        public ServerVersion(string message = default(string), bool isError = default(bool), string objectType = default(string), int statusCode = default(int), string _object = default(string))
        {
        ...
        /// </summary>
        /// <value>The BJR server version</value>
