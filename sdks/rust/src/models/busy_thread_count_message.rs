...
pub struct BusyThreadCountMessage {
    ...
    pub object: Option<Box<crate::models::BusyThreadCountMessageObject>>,
}

impl BusyThreadCountMessage {
    pub fn new() -> BusyThreadCountMessage {
