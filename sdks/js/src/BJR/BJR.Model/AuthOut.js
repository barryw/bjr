...
* @module BJR/BJR.Model/AuthOut
* @version v1
*/
export default class AuthOut {
    /**
    * Constructs a new <code>AuthOut</code>.
    * @alias module:BJR/BJR.Model/AuthOut
    * @class
    */
    ...
    * @param {module:BJR/BJR.Model/AuthOut} obj Optional instance to populate.
    * @return {module:BJR/BJR.Model/AuthOut} The populated <code>AuthOut</code> instance.
    */
