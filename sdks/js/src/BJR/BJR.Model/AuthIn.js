...
* @module BJR/BJR.Model/AuthIn
* @version v1
*/
export default class AuthIn {
    /**
    * Constructs a new <code>AuthIn</code>.
    * @alias module:BJR/BJR.Model/AuthIn
    * @class
    */
    ...
    * @param {module:BJR/BJR.Model/AuthIn} obj Optional instance to populate.
    * @return {module:BJR/BJR.Model/AuthIn} The populated <code>AuthIn</code> instance.
    */
