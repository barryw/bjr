...
* @module BJR/BJR.Model/JobIn
* @version v1
*/
export default class JobIn {
    /**
    * Constructs a new <code>JobIn</code>.
    * @alias module:BJR/BJR.Model/JobIn
    * @class
    */
    ...
    * @param {module:BJR/BJR.Model/JobIn} obj Optional instance to populate.
    * @return {module:BJR/BJR.Model/JobIn} The populated <code>JobIn</code> instance.
    */
