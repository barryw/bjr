...
* @module BJR/BJR.Model/UserUpdateIn
* @version v1
*/
export default class UserUpdateIn {
    /**
    * Constructs a new <code>UserUpdateIn</code>.
    * @alias module:BJR/BJR.Model/UserUpdateIn
    * @class
    */
    ...
    * @param {module:BJR/BJR.Model/UserUpdateIn} obj Optional instance to populate.
    * @return {module:BJR/BJR.Model/UserUpdateIn} The populated <code>UserUpdateIn</code> instance.
    */
