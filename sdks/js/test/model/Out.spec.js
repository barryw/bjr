...
(function(root, factory) {
  ...
  describe('Out', function() {
    it('should create an instance of Out', function() {
      // uncomment below and update the code to test Out
      //var instane = new BjrApiV1.Out();
      //expect(instance).to.be.a(BjrApiV1.Out);
    });
