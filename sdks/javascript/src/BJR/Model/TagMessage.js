...
* @module BJR/Model/TagMessage
* @version v1
*/
export default class TagMessage {
    /**
    * Constructs a new <code>TagMessage</code>.
    * @alias module:BJR/Model/TagMessage
    * @class
    */
    ...
    * @param {module:BJR/Model/TagMessage} obj Optional instance to populate.
    * @return {module:BJR/Model/TagMessage} The populated <code>TagMessage</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('object')) {
                obj['object'] = TagArray.constructFromObject(data['object']);
            }
        }
        return obj;
    }
    ...
    */
    ...
    /**
    * @member {module:BJR/Model/TagArray} object
    */
    object = undefined;
