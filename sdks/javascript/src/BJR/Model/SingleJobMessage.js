...
* @module BJR/Model/SingleJobMessage
* @version v1
*/
export default class SingleJobMessage {
    /**
    * Constructs a new <code>SingleJobMessage</code>.
    * @alias module:BJR/Model/SingleJobMessage
    * @class
    */
    ...
    * @param {module:BJR/Model/SingleJobMessage} obj Optional instance to populate.
    * @return {module:BJR/Model/SingleJobMessage} The populated <code>SingleJobMessage</code> instance.
    */
