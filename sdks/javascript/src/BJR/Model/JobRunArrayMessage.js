...
import JobRunArray from './JobRunArray';

/**
* The JobRunArrayMessage model module.
* @module BJR/Model/JobRunArrayMessage
* @version v1
*/
export default class JobRunArrayMessage {
    /**
    * Constructs a new <code>JobRunArrayMessage</code>.
    * @alias module:BJR/Model/JobRunArrayMessage
    * @class
    */
    ...
    * @param {module:BJR/Model/JobRunArrayMessage} obj Optional instance to populate.
    * @return {module:BJR/Model/JobRunArrayMessage} The populated <code>JobRunArrayMessage</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('object')) {
                obj['object'] = JobRunArray.constructFromObject(data['object']);
            }
        }
        return obj;
    }
    ...
    */
    ...
    /**
    * @member {module:BJR/Model/JobRunArray} object
    */
    object = undefined;
