...
* @module BJR/Model/TimezoneMessage
* @version v1
*/
export default class TimezoneMessage {
    /**
    * Constructs a new <code>TimezoneMessage</code>.
    * @alias module:BJR/Model/TimezoneMessage
    * @class
    */
    ...
    * @param {module:BJR/Model/TimezoneMessage} obj Optional instance to populate.
    * @return {module:BJR/Model/TimezoneMessage} The populated <code>TimezoneMessage</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('object')) {
                obj['object'] = StringArray.constructFromObject(data['object']);
            }
        }
        return obj;
    }
    ...
    */
    ...
    /**
    * @member {module:BJR/Model/StringArray} object
    */
    object = undefined;
