...
* @module BJR/Model/SingleJobRunMessage
* @version v1
*/
export default class SingleJobRunMessage {
    /**
    * Constructs a new <code>SingleJobRunMessage</code>.
    * @alias module:BJR/Model/SingleJobRunMessage
    * @class
    */
    ...
    * @param {module:BJR/Model/SingleJobRunMessage} obj Optional instance to populate.
    * @return {module:BJR/Model/SingleJobRunMessage} The populated <code>SingleJobRunMessage</code> instance.
    */
    ...
    */
    ...
    /**
    * @member {module:BJR/Model/SingleJobRun} object
    */
    object = undefined;
