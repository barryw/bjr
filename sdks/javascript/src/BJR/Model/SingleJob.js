...
export default class SingleJob {
    ...
    * @param {module:BJR/Model/SingleJob} obj Optional instance to populate.
    * @return {module:BJR/Model/SingleJob} The populated <code>SingleJob</code> instance.
    */
