...
export default class UserNewIn {
    ...
    * @param {module:BJR/Model/UserNewIn} obj Optional instance to populate.
    * @return {module:BJR/Model/UserNewIn} The populated <code>UserNewIn</code> instance.
    */
