...
import DateTimeArray from './DateTimeArray';

/**
* The OccurrenceMessage model module.
* @module BJR/Model/OccurrenceMessage
* @version v1
*/
export default class OccurrenceMessage {
    /**
    * Constructs a new <code>OccurrenceMessage</code>.
    * @alias module:BJR/Model/OccurrenceMessage
    * @class
    */
    ...
    * @param {module:BJR/Model/OccurrenceMessage} obj Optional instance to populate.
    * @return {module:BJR/Model/OccurrenceMessage} The populated <code>OccurrenceMessage</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('object')) {
                obj['object'] = DateTimeArray.constructFromObject(data['object']);
            }
        }
        return obj;
    }
    ...
    */
    ...
    /**
    * @member {module:BJR/Model/DateTimeArray} object
    */
    object = undefined;
