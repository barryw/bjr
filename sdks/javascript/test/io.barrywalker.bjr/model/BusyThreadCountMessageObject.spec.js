...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bjr4js.BusyThreadCountMessageObject();
  });
  ...
  describe('BusyThreadCountMessageObject', function() {
    it('should create an instance of BusyThreadCountMessageObject', function() {
      // uncomment below and update the code to test BusyThreadCountMessageObject
      //var instane = new Bjr4js.BusyThreadCountMessageObject();
      //expect(instance).to.be.a(Bjr4js.BusyThreadCountMessageObject);
    });
