...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bjr4js.JobsPerDayObject();
  });
  ...
  describe('JobsPerDayObject', function() {
    it('should create an instance of JobsPerDayObject', function() {
      // uncomment below and update the code to test JobsPerDayObject
      //var instane = new Bjr4js.JobsPerDayObject();
      //expect(instance).to.be.a(Bjr4js.JobsPerDayObject);
    });
