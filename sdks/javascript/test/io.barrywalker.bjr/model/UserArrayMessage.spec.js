...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bjr4js.UserArrayMessage();
  });
  ...
  describe('UserArrayMessage', function() {
    it('should create an instance of UserArrayMessage', function() {
      // uncomment below and update the code to test UserArrayMessage
      //var instane = new Bjr4js.UserArrayMessage();
      //expect(instance).to.be.a(Bjr4js.UserArrayMessage);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new Bjr4js.UserArrayMessage();
