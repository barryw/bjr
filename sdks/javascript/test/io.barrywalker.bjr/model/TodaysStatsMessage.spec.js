...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bjr4js.TodaysStatsMessage();
  });
  ...
  describe('TodaysStatsMessage', function() {
    it('should create an instance of TodaysStatsMessage', function() {
      // uncomment below and update the code to test TodaysStatsMessage
      //var instane = new Bjr4js.TodaysStatsMessage();
      //expect(instance).to.be.a(Bjr4js.TodaysStatsMessage);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new Bjr4js.TodaysStatsMessage();
