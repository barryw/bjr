...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bjr4js.ServerVersion();
  });
  ...
  describe('ServerVersion', function() {
    it('should create an instance of ServerVersion', function() {
      ...
      //var instane = new Bjr4js.ServerVersion();
      //expect(instance).to.be.a(Bjr4js.ServerVersion);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new Bjr4js.ServerVersion();
