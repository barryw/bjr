...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bjr4js.UserUpdateIn();
  });
  ...
  describe('UserUpdateIn', function() {
    it('should create an instance of UserUpdateIn', function() {
      // uncomment below and update the code to test UserUpdateIn
      //var instane = new Bjr4js.UserUpdateIn();
      //expect(instance).to.be.a(Bjr4js.UserUpdateIn);
    });

    it('should have the property password (base name: "password")', function() {
      // uncomment below and update the code to test the property password
      //var instance = new Bjr4js.UserUpdateIn();
