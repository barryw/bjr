...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bjr4js.GenericMessage();
  });
  ...
  describe('GenericMessage', function() {
    it('should create an instance of GenericMessage', function() {
      // uncomment below and update the code to test GenericMessage
      //var instane = new Bjr4js.GenericMessage();
      //expect(instance).to.be.a(Bjr4js.GenericMessage);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new Bjr4js.GenericMessage();
