...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bjr4js.JobStatMessage();
  });
  ...
  describe('JobStatMessage', function() {
    it('should create an instance of JobStatMessage', function() {
      // uncomment below and update the code to test JobStatMessage
      //var instane = new Bjr4js.JobStatMessage();
      //expect(instance).to.be.a(Bjr4js.JobStatMessage);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new Bjr4js.JobStatMessage();
