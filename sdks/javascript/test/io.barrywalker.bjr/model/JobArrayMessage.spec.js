...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bjr4js.JobArrayMessage();
  });
  ...
  describe('JobArrayMessage', function() {
    it('should create an instance of JobArrayMessage', function() {
      // uncomment below and update the code to test JobArrayMessage
      //var instane = new Bjr4js.JobArrayMessage();
      //expect(instance).to.be.a(Bjr4js.JobArrayMessage);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new Bjr4js.JobArrayMessage();
