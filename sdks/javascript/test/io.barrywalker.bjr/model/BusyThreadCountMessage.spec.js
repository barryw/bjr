...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bjr4js.BusyThreadCountMessage();
  });
  ...
  describe('BusyThreadCountMessage', function() {
    it('should create an instance of BusyThreadCountMessage', function() {
      // uncomment below and update the code to test BusyThreadCountMessage
      //var instane = new Bjr4js.BusyThreadCountMessage();
      //expect(instance).to.be.a(Bjr4js.BusyThreadCountMessage);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new Bjr4js.BusyThreadCountMessage();
