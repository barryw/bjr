...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bjr4js.TimezoneMessage();
  });
  ...
  describe('TimezoneMessage', function() {
    it('should create an instance of TimezoneMessage', function() {
      // uncomment below and update the code to test TimezoneMessage
      //var instane = new Bjr4js.TimezoneMessage();
      //expect(instance).to.be.a(Bjr4js.TimezoneMessage);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new Bjr4js.TimezoneMessage();
