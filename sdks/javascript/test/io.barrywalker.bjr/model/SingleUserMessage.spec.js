...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bjr4js.SingleUserMessage();
  });
  ...
  describe('SingleUserMessage', function() {
    it('should create an instance of SingleUserMessage', function() {
      // uncomment below and update the code to test SingleUserMessage
      //var instane = new Bjr4js.SingleUserMessage();
      //expect(instance).to.be.a(Bjr4js.SingleUserMessage);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new Bjr4js.SingleUserMessage();
