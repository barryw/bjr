...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bjr4js.SingleJobRunMessage();
  });
  ...
  describe('SingleJobRunMessage', function() {
    it('should create an instance of SingleJobRunMessage', function() {
      // uncomment below and update the code to test SingleJobRunMessage
      //var instane = new Bjr4js.SingleJobRunMessage();
      //expect(instance).to.be.a(Bjr4js.SingleJobRunMessage);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new Bjr4js.SingleJobRunMessage();
