...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bjr4js.SingleJobMessage();
  });
  ...
  describe('SingleJobMessage', function() {
    it('should create an instance of SingleJobMessage', function() {
      // uncomment below and update the code to test SingleJobMessage
      //var instane = new Bjr4js.SingleJobMessage();
      //expect(instance).to.be.a(Bjr4js.SingleJobMessage);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new Bjr4js.SingleJobMessage();
