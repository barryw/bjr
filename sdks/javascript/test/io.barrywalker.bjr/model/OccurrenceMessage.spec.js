...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bjr4js.OccurrenceMessage();
  });
  ...
  describe('OccurrenceMessage', function() {
    it('should create an instance of OccurrenceMessage', function() {
      // uncomment below and update the code to test OccurrenceMessage
      //var instane = new Bjr4js.OccurrenceMessage();
      //expect(instance).to.be.a(Bjr4js.OccurrenceMessage);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new Bjr4js.OccurrenceMessage();
