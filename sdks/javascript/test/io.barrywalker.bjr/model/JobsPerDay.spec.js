...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bjr4js.JobsPerDay();
  });
  ...
  describe('JobsPerDay', function() {
    it('should create an instance of JobsPerDay', function() {
      // uncomment below and update the code to test JobsPerDay
      //var instane = new Bjr4js.JobsPerDay();
      //expect(instance).to.be.a(Bjr4js.JobsPerDay);
    });
