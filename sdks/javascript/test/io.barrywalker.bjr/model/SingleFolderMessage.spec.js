...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bjr4js.SingleFolderMessage();
  });
  ...
  describe('SingleFolderMessage', function() {
    it('should create an instance of SingleFolderMessage', function() {
      // uncomment below and update the code to test SingleFolderMessage
      //var instane = new Bjr4js.SingleFolderMessage();
      //expect(instance).to.be.a(Bjr4js.SingleFolderMessage);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new Bjr4js.SingleFolderMessage();
