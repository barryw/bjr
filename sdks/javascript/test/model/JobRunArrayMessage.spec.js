...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BjrApiV1.JobRunArrayMessage();
  });
  ...
  describe('JobRunArrayMessage', function() {
    it('should create an instance of JobRunArrayMessage', function() {
      // uncomment below and update the code to test JobRunArrayMessage
      //var instane = new BjrApiV1.JobRunArrayMessage();
      //expect(instance).to.be.a(BjrApiV1.JobRunArrayMessage);
    });
