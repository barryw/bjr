...
(function(root, factory) {
  ...
  describe('AuthOut', function() {
    it('should create an instance of AuthOut', function() {
      // uncomment below and update the code to test AuthOut
      //var instane = new BjrApiV1.AuthOut();
      //expect(instance).to.be.a(BjrApiV1.AuthOut);
    });
