...
namespace BJR.Model
{
        ...
        public partial class JobArrayMessage :  IEquatable<JobArrayMessage>, IValidatableObject
    {
        ...
        public JobArrayMessage(string message = default(string), bool? isError = default(bool?), string objectType = default(string), int? statusCode = default(int?), JobArray _object = default(JobArray))
        {
        ...
        public JobArray Object { get; set; }
