...
namespace BJR.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class JobRunArrayMessage :  IEquatable<JobRunArrayMessage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JobRunArrayMessage" /> class.
        /// </summary>
        ...
        public JobRunArrayMessage(string message = default(string), bool? isError = default(bool?), string objectType = default(string), int? statusCode = default(int?), JobRunArray _object = default(JobRunArray))
        {
        ...
        public JobRunArray Object { get; set; }
        ...
        {
            return this.Equals(input as JobRunArrayMessage);
        }

        /// <summary>
        /// Returns true if JobRunArrayMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of JobRunArrayMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobRunArrayMessage input)
        {
            if (input == null)
                return false;
