...
namespace BJR.Model
{
    ...
    public partial class UserNewIn :  IEquatable<UserNewIn>, IValidatableObject
    {
        ...
        public UserNewIn(string username = default(string), string password = default(string), string passwordConfirmation = default(string))
        {
            ...
            if (username == null)
            {
                throw new InvalidDataException("username is a required property for UserNewIn and cannot be null");
            }
            else
            {
            ...
            if (password == null)
            {
                throw new InvalidDataException("password is a required property for UserNewIn and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("passwordConfirmation is a required property for UserNewIn and cannot be null");
            }
            else
            {
