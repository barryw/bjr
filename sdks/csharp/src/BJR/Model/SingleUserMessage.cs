...
namespace BJR.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SingleUserMessage :  IEquatable<SingleUserMessage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SingleUserMessage" /> class.
        /// </summary>
        ...
        public SingleUserMessage(string message = default(string), bool? isError = default(bool?), string objectType = default(string), int? statusCode = default(int?), SingleUser _object = default(SingleUser))
        {
        ...
        {
            return this.Equals(input as SingleUserMessage);
        }

        /// <summary>
        /// Returns true if SingleUserMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of SingleUserMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SingleUserMessage input)
        {
            if (input == null)
                return false;
