...
namespace BJR.Model
{
        ...
        public partial class OccurrenceMessage :  IEquatable<OccurrenceMessage>, IValidatableObject
    {
        ...
        public OccurrenceMessage(string message = default(string), bool? isError = default(bool?), string objectType = default(string), int? statusCode = default(int?), DateTimeArray _object = default(DateTimeArray))
        {
        ...
        public DateTimeArray Object { get; set; }
