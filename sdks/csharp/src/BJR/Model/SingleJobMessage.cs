...
namespace BJR.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SingleJobMessage :  IEquatable<SingleJobMessage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SingleJobMessage" /> class.
        /// </summary>
        ...
        public SingleJobMessage(string message = default(string), bool? isError = default(bool?), string objectType = default(string), int? statusCode = default(int?), SingleJob _object = default(SingleJob))
        {
        ...
        public SingleJob Object { get; set; }
        ...
        {
            return this.Equals(input as SingleJobMessage);
        }

        /// <summary>
        /// Returns true if SingleJobMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of SingleJobMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SingleJobMessage input)
        {
            if (input == null)
                return false;
