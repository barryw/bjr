...
namespace BJR.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class JobsPerDay :  IEquatable<JobsPerDay>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JobsPerDay" /> class.
        /// </summary>
        ...
        public JobsPerDay(string message = default(string), bool isError = default(bool), string objectType = default(string), int statusCode = default(int), List<JobsPerDayObject> _object = default(List<JobsPerDayObject>))
        {
        ...
        public List<JobsPerDayObject> Object { get; set; }
        ...
        {
            return this.Equals(input as JobsPerDay);
        }

        /// <summary>
        /// Returns true if JobsPerDay instances are equal
        /// </summary>
        /// <param name="input">Instance of JobsPerDay to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobsPerDay input)
        {
            if (input == null)
                return false;
