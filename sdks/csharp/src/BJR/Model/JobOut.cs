...
namespace BJR.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class JobOut :  IEquatable<JobOut>, IValidatableObject
    {
        /// <summary>
        ...
        public JobOut(string message = default(string), bool? isError = default(bool?), string objectType = default(string), int? statusCode = default(int?), SingleJob _object = default(SingleJob))
        {
        ...
        {
            return this.Equals(input as JobOut);
        }

        /// <summary>
        /// Returns true if JobOut instances are equal
        /// </summary>
        /// <param name="input">Instance of JobOut to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobOut input)
        {
            if (input == null)
                return false;
