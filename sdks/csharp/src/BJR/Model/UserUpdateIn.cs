...
namespace BJR.Model
{
    ...
    public partial class UserUpdateIn :  IEquatable<UserUpdateIn>, IValidatableObject
    {
        ...
        public UserUpdateIn(string password = default(string), string passwordConfirmation = default(string))
        {
            ...
            if (password == null)
            {
                throw new InvalidDataException("password is a required property for UserUpdateIn and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("passwordConfirmation is a required property for UserUpdateIn and cannot be null");
            }
            else
            {
