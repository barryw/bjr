...
namespace BJR.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TagMessage :  IEquatable<TagMessage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagMessage" /> class.
        /// </summary>
        ...
        public TagMessage(string message = default(string), bool? isError = default(bool?), string objectType = default(string), int? statusCode = default(int?), TagArray _object = default(TagArray))
        {
        ...
        public TagArray Object { get; set; }
        ...
        {
            return this.Equals(input as TagMessage);
        }

        /// <summary>
        /// Returns true if TagMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of TagMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TagMessage input)
        {
            if (input == null)
                return false;
