...
namespace BJR.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TimezoneMessage :  IEquatable<TimezoneMessage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TimezoneMessage" /> class.
        /// </summary>
        ...
        public TimezoneMessage(string message = default(string), bool? isError = default(bool?), string objectType = default(string), int? statusCode = default(int?), StringArray _object = default(StringArray))
        {
        ...
        public StringArray Object { get; set; }
        ...
        {
            return this.Equals(input as TimezoneMessage);
        }

        /// <summary>
        /// Returns true if TimezoneMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of TimezoneMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimezoneMessage input)
        {
            if (input == null)
                return false;
