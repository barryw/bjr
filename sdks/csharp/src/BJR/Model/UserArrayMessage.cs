...
namespace BJR.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UserArrayMessage :  IEquatable<UserArrayMessage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserArrayMessage" /> class.
        /// </summary>
        ...
        public UserArrayMessage(string message = default(string), bool? isError = default(bool?), string objectType = default(string), int? statusCode = default(int?), UserArray _object = default(UserArray))
        {
        ...
        public UserArray Object { get; set; }
        ...
        {
            return this.Equals(input as UserArrayMessage);
        }

        /// <summary>
        /// Returns true if UserArrayMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of UserArrayMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserArrayMessage input)
        {
            if (input == null)
                return false;
