...
namespace BJR.Api
{
    ...
    public partial class AuthenticationApi : IAuthenticationApi
    {
        ...
        {
             ApiResponse<AuthOut> localVarResponse = AuthenticateUserWithHttpInfo(authIn);
        ...
        /// <param name="authIn"> (optional)</param>
        /// <returns>ApiResponse of AuthOut</returns>
        public ApiResponse<AuthOut> AuthenticateUserWithHttpInfo (AuthIn authIn = default(AuthIn))
        {
