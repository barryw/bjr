...
namespace IO.Swagger.BJR.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ModelOut :  IEquatable<ModelOut>, IValidatableObject
    {
        /// <summary>
        ...
        public ModelOut(string message = default(string), bool? isError = default(bool?), string objectType = default(string), int? statusCode = default(int?), AnyOfOutObject _object = default(AnyOfOutObject))
        {
        ...
        public AnyOfOutObject Object { get; set; }
        ...
        {
            return this.Equals(input as ModelOut);
        }

        /// <summary>
        /// Returns true if ModelOut instances are equal
        /// </summary>
        /// <param name="input">Instance of ModelOut to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModelOut input)
        {
            if (input == null)
                return false;
