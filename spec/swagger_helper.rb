        ...
        schemas: {
          ...
          BusyThreadCountMessage: {
            ...
            properties: {
              ...
              object: { type: :object,
                properties: {
                  total_busy: { type: :integer, description: 'The total number of busy workers across all pods/hosts.' },
                  hosts: { type: :array, items: { type: :object,
                                                  properties: {
                                                    name: { type: :string, description: 'The name of the worker host.' },
                                                    busy: { type: :integer, description: 'The number of busy threads on the worker.' },
                                                    pid: { type: :integer, description: 'The process ID of the worker process.' }
                                                  }
                    }
                  }
                }
          ...
          SingleJobRun: {
            ...
            properties: {
              ...
              scheduled_start_time: { type: :string, format: 'date-time', description: 'The date and time that the job should have run.', nullable: true },
              schedule_diff_in_seconds: { type: :integer, description: 'The difference in seconds between when the job was scheduled to run and when it ran.', nullable: true },
