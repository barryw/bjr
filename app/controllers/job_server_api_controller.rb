...
class JobServerApiController < ApplicationController
  ...
  def minutely_job_stats
    ...
    message(I18n.t('jobserver.messages.minutely_job_stats.failed'), :not_acceptable, true, [], 'jobstats') && return if count > 60
  ...
  def recent_jobs
    ...
    message(I18n.t('jobserver.messages.recent_jobs.failed'), :not_acceptable, true, [], 'jobs') && return if count > 20
